...
const GeneratedResume = ({ 
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(template, {
        ...
        onclone: (clonedDoc) => {
          const el = clonedDoc.querySelector('#template-to-print');
          if (el) {
  ...
  //           pdf.addImage(imgData, 'JPEG',  imgWidth, imgHeight);
  //     pdf.save(`${formData.firstname}_${formData.lastname}_resume.pdf`);
  //   } catch (error) {
  //     console.error('Error generating PDF:', error);
  //   } finally {
...
<div id="template-to-print" className="w-[210mm] min-h-[297mm] p-[20mm] bg-white">

     {/* <div className="w-full min-h-[600px] p-8 mt-3 md:mt-0  bg-red-300"> */}
...
{educationData.map((edu, index) => (
  ...
  const Template3 = () => (
    <div id="template-to-print" className="w-[210mm] min-h-[297mm] p-[20mm] bg-white"style={{ fontFamily: 'Times New Roman, serif' }} >
...
<section>
  ...
  return (
    ...
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 p-20">
